...
4.	Install CUDA Toolkit 10.1 and cuDNN 10.1 for a K3 control PC if the operating system of the PC is Windows Server 2012R2.  CUDA 10.1 is the final version supporting Windows Server 2012R2. Newer versions of CUDA and cuDNN are available for Windows 10.
